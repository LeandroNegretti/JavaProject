...
public class DAO {
	...
	public Cliente consultarCliente(String id) throws Exception {
		...
		if (cliente == null) {
			JOptionPane.showMessageDialog(null, "Não foi localizar o cliente selecionado ", "",
					JOptionPane.WARNING_MESSAGE);
			throw new Exception("Não foi localizar o cliente selecionado ");
		}
		return cliente;
	}
	...
	public Usuario consultarUsuario(String nomeUsuario, String senhaCriptografada) throws Exception {
		...
		if (usuario == null) {
			JOptionPane.showMessageDialog(null, "Não foi possivel localizar o usuario selecionado ", "",
					JOptionPane.WARNING_MESSAGE);
			throw new Exception("Não foi localizar o usuario selecionado ");
		}
		return usuario;
	}
